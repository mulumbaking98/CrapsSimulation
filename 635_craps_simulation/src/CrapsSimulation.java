...
//	public static final int NUM_TO_PLAY = 1000000;
	...
	public CrapsSimulation()
	{
		...
		game = new CrapsGame(new Die(), new CrookedDie1()); // two "fair" Die objects ******try rename fair die*******
	...
	public void play(int n)  
	{
		...
		{
			if (game.playOneGame(winForNumberOfStepsOf, lossSteps)) //change win for numbers of step
			{
				numberOfWins++;
			}
		}
	 ...
	 */
	public static final int NUM_TO_PLAY = 1000000; //moved here from above
